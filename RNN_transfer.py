...
from models import FFNN, RecurrentNeuralNetwork
...
for i in range(0,n_different_training):
	normal_FFNN = RecurrentNeuralNetwork(trainable=trainable,feature_number=feature_number,frame_number=frame_number,emotions=emotions,lr=0.0001)
	print("           NORMAL MODEL ")
