...
model.add(Dense(256, activation='relu', name='dense_2',kernel_initializer='glorot_normal'))
model.add(Dropout(0.5))
model.add(Dense(256, activation='relu', name='dense_3',kernel_initializer='glorot_normal'))
model.add(Dropout(0.5))
model.add(Dense(256, activation='relu', name='dense_4',kernel_initializer='glorot_normal'))
#model.add(Dropout(0.5))
