...
emotions = ['ang','exc']#,'ang','exc']
size_batch = 32
frame_number = 20


model = Sequential()
model.add(Dense(256, activation='relu', input_dim=frame_number*33, name='dense_1',kernel_initializer='VarianceScaling'))
#model.add(Dropout(0.5))
model.add(Dense(256, activation='relu', name='dense_2',kernel_initializer='VarianceScaling'))
#model.add(Dropout(0.5))
model.add(Dense(256, activation='relu', name='dense_3',kernel_initializer='VarianceScaling'))
#model.add(Dropout(0.5))
model.add(Dense(256, activation='relu', name='dense_4',kernel_initializer='VarianceScaling'))
#model.add(Dropout(0.5))
